...
%	However, it should not be forgotten that various scaling solutions are on the horizon. Moreover, a public deployment does not require bootstrapping the underlying mechanisms. Also, it offers a very high degree of decentralization which is important for health, resiliency and censorship resistance. 

%	The latter of which is also a cost optimization measure that has been implemented.
%
%
%Decentralization is a spectrum; it's not binary

%Also, it must be reiterated that the implementation omits two aspects which are essential to production. The reason is that they have been identified as being out of scope because they largely depend on the . 
