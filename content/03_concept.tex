...
\begin{description}
	...
	\item[Permissioned]
	\hfill \\
	A more predictable approach involves permissioned blockchains, commonly referred to as private deployments. These are operated by a known, authorized set of miners who use Ether at constant value. Ergo, the solution can be used as is, though assumes that:
