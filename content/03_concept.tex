...
\begin{description}
	\item[Ethereum Main-Chain (Public)]
	\hfill \\
...
From here, the general advantages and traits of a blockchain-based solution should be highlighted with respect to the non-functional requirements defined in \autoref{sec:NFRs}. Similar to \autoref{sec:depositConversion}, public and private deployment has to be taken into account.
