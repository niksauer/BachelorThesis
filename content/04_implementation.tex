...
OpenZeppelin provides \ac{dApp} developers with a library of smart-contracts that are tested and community-reviewed (comp.~\ref{itm:penalty} on \autopageref{itm:penalty}). This project utilizes two of its components:
...
%\Cref{sec:componentDesign}
%As decided by , 
%
%
%To realize the application's vision of establishing a fully autonomous debt-tracking entity, two changes will be required in respect to the 
