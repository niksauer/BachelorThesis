...
\newglossaryentry{ecologically advantageous packaging}{
	...
	description={Packaging that does now show any significant ecological disadvantages when compared to reusable packaging \cite[pp.~83]{Flanderka/Stroetmann 2009}}
}
