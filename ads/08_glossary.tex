...
\newglossaryentry{reusable packaging}{
	...
	description={Packaging intended to be reused for the same purpose after having been used. Can be taken back, cleaned and refilled by companies who have issued such packaging. The sole intention or claim to be reused is not valid \cite[§~3]{verpackV1991}}
}
...
\newglossaryentry{counterparty risk}{
	...
	description={Risk that the other party in a transaction will fail to meet his or her obligations \cite[p.~175]{Antonopoulos.2018}}
}

\newglossaryentry{nonce}{
	name={nonce},
	description={Generally, a value that can only be used once. Here: number of confirmed transactions that have originated from an account \cite[pp.~17, 148]{Antonopoulos.2018}}
}
